...
A self-serve design studio for university finalists. Pick a template made by a designer, drop your details in, pay ₦1,000, walk away with a print-ready file. No back-and-forth. No waiting list. No mystery quote.

---

## Why this exists

Every final year, the same scene plays out on every campus.
...
**₦1,000 per design.** That is the whole price. There is no consultation fee, no rush charge, no "the designer is asking for an extra two thousand because the file is large." Pay once, download once, keep the file forever. If you want a second design, that is another ₦1,000. No subscription, no monthly cycle, no contract.

For a class of 200 finalists each putting together a personal design, the math is plain: a single Paystack receipt apiece, no group account, no shared folder, no class rep collecting and chasing.
...
A spotty connection in the middle of payment is not a lost ₦1,000. The moment Paystack confirms your payment, your download is reserved on your account. If the browser dies, the network drops, or you accidentally close the tab, your dashboard shows a **"Resume"** button waiting for you. One tap, and you are back where you stopped.

### Edit-after-download, free

Saw a typo on Instagram and want to fix the design before sending it to the printer? Open it from your dashboard, edit the typo, re-export. As many times as you like. Editing is always free; the ₦1,000 is for the *first* download of a fresh design.
...
Suspect the passcode leaked? Rotate it. The old one stops working immediately, and you share the new one in your department group chat. Done with the design after sign-out week? Release the lock and let the rest of the school use it again.

There is no monthly fee for locking. There is no limit on how many designs your department can lock. The system is built for the rhythm of an academic year.

### One head per department

Only one person per department can hold the head role. That keeps the responsibility clear, prevents two presidents from rotating each other's passcodes, and means a member always knows whose code to ask for.

---

## What it costs

**₦1,000.** Per design. Once.
...
## How it actually feels, in five steps

1. **Sign in with Google.** No password to remember, no email-confirmation loop. One tap.
2. **Tell us your department and class.** Once, on your first visit. We use it to fill in your designs by default and to show you locked templates your department head reserved.
3. **Open a template.** The cover appears with input fields on the side. Type your name. Drop a photo. Watch the preview update.
4. **Pay ₦1,000 with Paystack.** Card or bank transfer, takes about ten seconds.
5. **Download.** A high-resolution PNG, ready for the printer or the timeline.

If anything goes wrong at any step, your work is on your device and your payment is reserved on your account. Reload, resume, ship.

---

## The promise

Final year only happens once. The designs that mark it should not cost you a week of waiting, a chain of unanswered DMs, and a price you find out at the end. **FYB Studio gives you a designer-quality piece for the cost of a meal, in the time it takes to eat one, with full ownership of the result.**

Pick your moment. Drop your details in. Make it yours.
