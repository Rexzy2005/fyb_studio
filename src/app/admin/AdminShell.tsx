        ...
        {!sidebarHidden ? (
          ...
          >
            ...
            <nav className="flex-1 space-y-1 p-3 text-sm">
              ...
              <Link href="/admin/users" className="block rounded-xl px-3 py-2 text-zinc-700 hover:bg-zinc-50 dark:text-zinc-200 dark:hover:bg-zinc-800/60">
                <span className={collapsed ? "sr-only" : ""}>Users</span>
              </Link>
